...
builder.WebHost.ConfigureKestrel(options =>
{
    ...
    options.ListenAnyIP(5290, o => o.Protocols = HttpProtocols.Http2);
});
...
{
    o.Address = new Uri("http://mockqhd-pptservice:50104");
});
builder.Services.AddScoped<IDataService, QHDataService>();
